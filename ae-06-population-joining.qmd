...
We need to look at the columns in both datasets. population has a column named country. continents has a column named entity. These both contain country names. Therefore, we join country from the population dataset to entity from the continents dataset.
...
left_join(). We want to keep our primary dataset (population) intact and attach continent data where available.
...
population_continent <- population |>
  mutate(country = case_when(
    ...
    .default = country # Keep all other names the same
  )) |>
